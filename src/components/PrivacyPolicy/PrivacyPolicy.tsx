  ...
  return (
    <div className="py-8 pt-[100px] font-lato">
      <div className="custom-container">
        <h1 className="lg:text-[40px] text-[28px] pl-10  text-[#F28E2C] mb-8 font-sofia">
        ...
        <div className="relative w-full before:absolute before:top-0 before:left-[-10%] before:w-[110%] before:h-[1px] before:content-[''] pt-10 before:bg-[#E5E7EB] after:absolute after:top-[-10%] after:left-0 after:w-[1px] after:h-[110%] after:content-[''] after:bg-[#E5E7EB] pl-10">
          <div className="mb-4">
            ...
            <p>
              Welcome to Akinde Pixels. We value your privacy and are committed
              to protecting your personal information. This Privacy Policy
              explains how we collect, use, disclose, and safeguard your
              information when you visit our website [insert website URL],
              engage with our services, or interact with us in any other way. By
          ...
          <div className="mb-4">
            ...
            <p>
              We may collect personally identifiable information from you,
          ...
          <div className="mb-4">
            ...
            <p>
              ...
              services. You can set your browser to refuse cookies, but this may
          ...
          <div className="mb-4">
            ...
            <ul>
              <li>
                ...
                behalf, such as payment processing, email delivery, and
                analytics.
              </li>
              <li>
                Legal Requirements: We may disclose your information if required
                to do so by law or in response to legal processes.
              </li>
              <li>
          ...
          <div className="mb-4">
            ...
            <p>
              You have the following rights regarding your personal infromation:
            </p>
            <ul>
              <li>
              ...
              <li>
                Correction: You can request correction of any inaccuracies in
              ...
              <li>
                ...
                from us by following the unsubscribe instructions in the emails
          ...
          <div className="mb-4">
            ...
            <p>
              Client may terminate the Agreement (“Cancellation”) and/or
              reschedule the Services (“Rescheduling”) by providing Akinde
              Pixels with written notice no later than (10 days) before the
              original date of the Services (the “Minimum Notice”). Client
              acknowledges and agrees that Client is not relieved of any payment
              obligations for Cancellations and Rescheduling
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <p>
              ...
              efforts to accommodate Client&apos;s change despite using
              commercially reasonable efforts, the parties agree that such
              rescheduling will be deemed as cancellation by client and that
              Akinde Pixels will be under no obligation to perform the services
              other than on the original date of the services
            </p>
          </div>
