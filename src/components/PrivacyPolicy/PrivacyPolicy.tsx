    ...
    <div className="py-8 ">
      <div className="custom-container">
        ...
        <div className="mb-4 ">
          ...
          <p>
            Welcome to Akinde Pixels. We value your privacy and are committed to
            protecting your personal information. This Privacy Policy explains
            how we collect, use, disclose, and safeguard your information when
            you visit our website [insert website URL], engage with our
            services, or interact with us in any other way. By using our website
        ...
        <div className="mb-4 ">
          ...
          <ul>
            <li>
              ...
              payment processing, email delivery, and analytics.
            </li>
            <li>
        ...
        <div className="mb-4">
          ...
          <p>
            ...
            reschedule the Services (“Rescheduling”) by providing Akinde Pixels
            with written notice no later than (10 days) before the original date
            of the Services (the “Minimum Notice”). Client acknowledges and
            agrees that Client is not relieved of any payment obligations for
