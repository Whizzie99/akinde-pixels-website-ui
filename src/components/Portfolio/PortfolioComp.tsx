    ...
    <div>
      ...
      <div className="lg:flex gap-6 py-6">
        <div className="p-8 lg:block hidden">
          <Image src='/images/portfolio.png' width={300} height={100} alt="Portfolio Image" />
        </div>
        <div>
          ...
          <div className="relative">
            ...
            <p className="p-8">
              &ldquo;In our gallery, every wedding kiss, birthday smile, editorial shoot, 
              and portrait captures the beauty of the moment&rdquo;
            </p>
          </div>
        </div>
      </div>
