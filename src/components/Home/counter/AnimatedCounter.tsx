...
const AnimatedCounter = () => {
  ...
  return (
    <div ref={containerRef} className="lg:h-[20rem] h-[10rem] bg-[rgba(254,248,242,0.5)]">
      <div className="flex items-center justify-center h-full space-x-[2rem] custom-container">
        {counterItems.map((item, index) => (
          <div key={index} className="text-center shadow-[0_14px_28px_rgba(0,0,0,0.25),0_10px_10px_rgba(0,0,0,0.22)] p-2 lg:p-4 rounded">
