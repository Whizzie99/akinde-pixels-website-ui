      ...
      <div className="custom-container">
        ...
        <div className="flex justify-between lg:flex-row flex-col">
          ...
          <div className="flex gap-2 lg:mt-0 mt-4">
            <Image src={footpix} width={150} height={100} alt="" className="lg:w-full w-[382px] lg:h-auto h-[260px] object-cover"/>
            <Image src={footerPix1} width={150} height={100} alt="" className="lg:w-full object-cover hidden lg:inline"/>
          </div>
          <div className="lg:px-8 lg:mt-0 mt-4">
            <p className="text-[24px] capitalize text-center">Capture your moment</p>
